...
Here you can download the complete :download:`parameter file <code/MilleFEuiIle.zip>`\  and the :download:`matplotlib script <scripts/plot_convection.py>`\ for the animation.
