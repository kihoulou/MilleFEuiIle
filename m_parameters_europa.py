...
output_frequency = ["time", 200*kyr] # e.g. ["steps", 10] or ["time", 100*kyr]
...
BC_Stokes_problem = [["free_surface"],                # top boundary       (1)
                     ["velocity", 0.0, 1e3/Myr],    # bottom boundary    (2)
                     ["velocity_x", -1e3/Myr],       # left boundary      (3)
                     ["velocity_x", 1e3/Myr]]       # right boundary     (4)
